...
public class SalaryComputation {
    ...
    public static void main(String[] args) {
        ...
        // Hardcoded file path
        String filePath = "C:\\Users\\eihci\\Documents\\NetBeansProjects\\MO-IT101-Group1\\src\\payroll\\hub\\Copy of MotorPH Employee Data - Attendance Record.csv";

        System.out.print("Enter Employee ID: ");
        String employeeID = scanner.nextLine();

        try {
            double totalWorkedHours = calculateTotalHoursWorked(filePath, employeeID);
    ...
    private static double calculateTotalHoursWorked(String filePath, String employeeID) throws IOException {
        List<String> lines = Files.readAllLines(Paths.get(filePath));
        DateTimeFormatter timeFormatter = DateTimeFormatter.ofPattern("HH:mm");
